package sg.edu.rp.c346.id19020844.demotipsforexam;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // create an array to store a list of exam tips
        ...
        examTipsArray[1] = "Seek help from your lecturer ASAP, don't wait till you lost in the jungle";
